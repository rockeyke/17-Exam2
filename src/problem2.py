...
class Triangle(object):
    ...
    def area(self):
        ...
        perimeter = self.a.distance_from(self.b) + self.a.distance_from(self.c) + self.b.distance_from(self.c)
        S = (1/2) * perimeter
        area = (S * (S - self.a.distance_from(self.b)) * (S - self.a.distance_from(self.c)) *
                (S - self.b.distance_from(self.c))) ** (1/2)
        return area
    ...
    def return_doubled_triangle(self):
        ...
        double_a = Point(a.x * 2, a.y * 2)
        double_b = Point(b.x * 2, b.y * 2)
        double_c = Point(c.x * 2, c.y * 2)
        return Triangle(double_a, double_b, double_c)
